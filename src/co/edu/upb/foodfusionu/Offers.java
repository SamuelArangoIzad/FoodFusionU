...
public class Offers {
    ...
    static double[] totalCombos = new double[5];
    ...
    public static void verOfertas() {
        ...
        mostrarMenuPorDia(menuComidas, diasSemana, preciosComidas,opcion2);
         int seleccion = -1;
                do {
                    System.out.println("1. Añadir combo");
                    System.out.println("2. Salir");
                    System.out.print("Elija una opción: ");
                    seleccion = scanner.nextInt();
                    if (seleccion == 1) {
                        int combo = seleccionCombo();
                        if (combo >= 0) {
                            System.out.print("Ingrese la cantidad: ");
                            int cantidad = scanner.nextInt();
                            totalCombos[opcion2 - 1] += preciosComidas[opcion2 - 1][combo] * cantidad*0.5;
                            System.out.println("El valor a pagar es: $" + totalCombos[opcion2 - 1]);
                        }
                    }
                } while (seleccion != 2);
            } else if (opcion == 2) {
    ...
    public static void mostrarMenuPorDia(String[][] menuComidas, String[] diasSemana, double[][] preciosComidas,int opcion) {
